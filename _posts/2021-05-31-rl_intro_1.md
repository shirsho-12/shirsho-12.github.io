...
<figure>
    ...
    <figcaption>The Connect-4 game. Source: Wikipedia </figcaption>
</figure>
...
<img src="https://render.githubusercontent.com/render/math?math=V(s,a) \leftarrow V(s, a)"> + <img src="https://render.githubusercontent.com/render/math?math=\alpha [V_{best}(s') - V(s,a)]">
