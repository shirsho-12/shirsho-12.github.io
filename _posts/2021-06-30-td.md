...
```
<figure>
    <img src="/images/rl/taxi_env.png" desc="Taxi render output"> 
    <!-- decentralized -->
</figure>
...
<a name="myfootnote3">[2]</a> Hasselt, H. (2010). Double Q-learning. Advances in neural information processing systems, 23, 2613-2621.
