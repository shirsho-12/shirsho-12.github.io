...
export const projects: Project[] = [
  {
    ...
    description: "A web application that uses machine learning to generate images from text descriptions using OpenAI's DALL-E API.",
  ...
  },
  {
    ...
    description: "A secure and transparent voting system built on blockchain technology that ensures vote integrity and prevents fraud.",
  ...
  },
  {
    ...
    description: "A machine learning-based recommendation system that analyzes user behavior to suggest relevant products or content.",
  ...
  },
  {
    ...
    description: "A scalable chat application supporting multiple rooms, direct messaging, and media sharing with end-to-end encryption.",
  ...
  },
  {
    ...
    description: "A simulation of various CPU scheduling algorithms, including round-robin, priority scheduling, and shortest job first.",
