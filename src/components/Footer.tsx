        ...
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-300 max-w-md">
              Computer Science student specializing in software development, research, and technical writing.
            </p>
          </div>
          
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              <h4 className="text-sm font-semibold mb-3 text-gray-200">Navigation</h4>
            ...
            <div>
              <h4 className="text-sm font-semibold mb-3 text-gray-200">Connect</h4>
