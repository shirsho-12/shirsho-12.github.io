      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Have a question or interested in working together? Feel free to reach out using the form
              ...
              <CardContent className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Check out my code and projects</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">Connect professionally</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">For direct inquiries</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="mt-6">
              ...
              <CardContent>
                <p className="text-gray-600">
                  I'm generally available for virtual meetings Monday through Friday, 10 AM - 6 PM EST.
                  Feel free to suggest a time when reaching out!
                </p>
              </CardContent>
            </Card>
          </div>
