...
<!-- <center>
    <div class="col-sm mt-3 mt-md-0">
         {% include figure.html path="assets/img/rl/gym.png" class="row img-fluid rounded z-depth-1" zoomable=true caption="Is this working out?" alt="The OpenAI Gym" %}
    </div>
</center> -->
...
<!-- <center>
    <div class="col-sm mt-3 mt-md-0">
         {% include figure.html path="assets/img/rl/pytorch_install.png" class="row img-fluid rounded z-depth-1" zoomable=true caption="Select the relevant options from the website and run the resulting line of code on your system." alt="Installing PyTorch" %}
    </div>
</center> -->
...
<!-- <center>
    <div class="col-sm mt-3 mt-md-0">
         {% include figure.html path="assets/img/rl/pacman.png" class="row img-fluid rounded z-depth-1" zoomable=false alt="Ms. Pac-Man simulated" %}
    </div>
</center> -->
...
<center>
    <video width="500" height="375" controls>
        <source src="../../assets/img/rl/pacman.mp4" type="video/mp4">
    </video>
...
<!-- <center>
    <div class="col-sm mt-3 mt-md-0">
         {% include figure.html path="assets/img/rl/cartpole.gif" class="row img-fluid rounded z-depth-1" zoomable=true caption="Look at the pole go!" alt="Look at the pole go!" %}
    </div>
</center> -->
